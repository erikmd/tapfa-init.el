...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote (helpful discover-my-major which-key tabbar magit-gitflow magit learn-ocaml company-coq proof-general company merlin-iedit merlin-eldoc merlin tuareg use-package))))
